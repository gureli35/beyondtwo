        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 
              ...
              data-aos="fade-up"
            >
              <span className="text-primary-500">CLIMATE</span>
            ...
            >
              <p className="text-xl md:text-2xl font-bold text-white leading-relaxed">
                THE PLANET IS BURNING - ACTION IS NEEDED NOW!
              </p>
            </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h2 
              ...
              data-aos="fade-up"
            >
              <span className="bg-gradient-to-r from-primary to-red-600 bg-clip-text text-transparent">CRITICAL ISSUES</span>
            </h2>
            <p 
              ...
              data-aos-delay="200"
            >
              Understanding the most urgent climate challenges facing our planet
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            ...
            >
              ...
              <p className="text-white mb-6 text-lg opacity-90">
                These issues require immediate action. Join the movement and make a difference today.
              </p>
