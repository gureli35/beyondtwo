          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center" data-aos="fade-up">
              <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">
                {language === 'tr' ? 'Etki Haritası' : 'Impact Map'}
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                {language === 'tr' ? 'Dünya çapında gerçekleşen iklim projelerini ve girişimlerini keşfedin' : 'Discover climate projects and initiatives happening around the world'}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 text-center" data-aos="fade-up" data-aos-delay="200">
              <p className="text-gray-400 text-lg max-w-3xl mx-auto">
                {language === 'tr' 
                  ? 'İklim eylem projelerini, yenilenebilir enerji girişimlerini ve gezegenimizin geleceğine gerçek etki yapan sürdürülebilirlik çabalarını keşfedin'
                  : 'Explore climate action projects, renewable energy initiatives, and sustainability efforts making a real impact on our planet\'s future.'
                }
              </p>
            </div>
          </div>
        ...
        <section className="bg-gradient-black-red py-16 w-full">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              {language === 'tr' ? 'Değişimin Bir Parçası Olun' : 'Be Part of the Change'}
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              {language === 'tr' 
                ? 'İklim eylemi için küresel harekete katılın ve sürdürülebilir bir gelecek yaratmaya yardımcı olun'
            ...
            <Link href="/contact">
              <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-red-600/25">
                {language === 'tr' ? 'Dahil Olun' : 'Get Involved'}
              </button>
            </Link>
          </div>
        </section>
