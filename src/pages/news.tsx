...
// Static hosting için mock news data
const generateMockNewsData = (language: string): NewsArticle[] => {
  return [
    {
      id: 'climate-news-1',
      title: language === 'tr' ? 'COP29: İklim Finansmanında Yeni Anlaşma' : 'COP29: New Agreement on Climate Finance',
      summary: language === 'tr' 
        ? 'Dünya liderleri iklim değişikliğiyle mücadele için 300 milyar dolarlık fon konusunda anlaştı. Bu tarihi anlaşma gelişmekte olan ülkelere kritik destek sağlayacak.'
        : 'World leaders agreed on a $300 billion fund to combat climate change. This historic agreement will provide critical support to developing countries.',
      url: 'https://beyond2c.org',
      image: null,
      publishDate: new Date().toISOString(),
      source: 'Beyond2C Climate Report',
      category: language === 'tr' ? 'İklim Politikası' : 'Climate Policy',
      language: language
    },
    {
      id: 'climate-news-2',
      title: language === 'tr' ? 'Yenilenebilir Enerji Rekor Kırdı' : 'Renewable Energy Breaks Records',
      summary: language === 'tr' 
        ? '2024 yılında küresel yenilenebilir enerji kapasitesi %15 artış gösterdi. Güneş ve rüzgar enerjisi sektörleri büyümede öncülük ediyor.'
        : 'Global renewable energy capacity increased by 15% in 2024. Solar and wind energy sectors are leading the growth.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-3',
      title: language === 'tr' ? 'Arktik Buzullarda Hızlı Erime' : 'Rapid Melting in Arctic Glaciers',
      summary: language === 'tr' 
        ? 'NASA verilerine göre Arktik buzulları bu yıl normal ortalamanın %25 üzerinde erime gösterdi. Bilim insanları durumu kritik olarak değerlendiriyor.'
        : 'According to NASA data, Arctic glaciers showed 25% above normal melting this year. Scientists consider the situation critical.',
      url: 'https://beyond2c.org',
      image: null,
      publishDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      source: 'NASA Climate Change',
      category: language === 'tr' ? 'İklim Bilimi' : 'Climate Science',
      language: language
    },
    {
      id: 'climate-news-4',
      title: language === 'tr' ? 'Elektrikli Araç Satışları Artışta' : 'Electric Vehicle Sales Surge',
      summary: language === 'tr' 
        ? 'Küresel elektrikli araç satışları 2024\'te %40 artış gösterdi. Avrupa ve Çin pazarları büyümede öncülük ediyor.'
        : 'Global electric vehicle sales increased by 40% in 2024. European and Chinese markets are leading the growth.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-5',
      title: language === 'tr' ? 'Orman Koruma Projesi Başarıyla Tamamlandı' : 'Forest Conservation Project Successfully Completed',
      summary: language === 'tr' 
        ? 'Amazon ormanlarında 10 yıllık koruma projesi başarıyla tamamlandı. 500.000 hektar alan ormansızlaşmadan korundu.'
        : 'A 10-year conservation project in the Amazon forests was successfully completed. 500,000 hectares were protected from deforestation.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-6',
      title: language === 'tr' ? 'Karbonsuz Çelik Üretimi Geliştirildi' : 'Carbon-Free Steel Production Developed',
      summary: language === 'tr' 
        ? 'İsveçli şirket SSAB, dünyanın ilk karbonsuz çelik üretimini ticari ölçekte başlattı. Bu teknoloji sektörde devrim yaratabilir.'
        : 'Swedish company SSAB launched the world\'s first carbon-free steel production on a commercial scale. This technology could revolutionize the industry.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-7',
      title: language === 'tr' ? 'Deniz Seviyesi Artışı Hızlanıyor' : 'Sea Level Rise Accelerating',
      summary: language === 'tr' 
        ? 'IPCC raporuna göre deniz seviyesi artışı beklenenden %30 daha hızlı gerçekleşiyor. Kıyı kentleri için acil uyum planları gerekiyor.'
        : 'According to IPCC report, sea level rise is occurring 30% faster than expected. Urgent adaptation plans are needed for coastal cities.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-8',
      title: language === 'tr' ? 'Yeşil Hidrojen Yatırımları Artıyor' : 'Green Hydrogen Investments Growing',
      summary: language === 'tr' 
        ? 'Küresel yeşil hidrojen yatırımları 2024\'te 100 milyar doları aştı. Enerji depolama ve taşımacılık sektörlerinde umut veriyor.'
        : 'Global green hydrogen investments exceeded $100 billion in 2024. It shows promise in energy storage and transportation sectors.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-9',
      title: language === 'tr' ? 'Çiftçiler İklim Dostu Tarıma Geçiyor' : 'Farmers Shift to Climate-Friendly Agriculture',
      summary: language === 'tr' 
        ? 'Avrupa\'da çiftçilerin %60\'ı sürdürülebilir tarım uygulamalarını benimsiyor. Karbon ayak izini azaltma hedefi güdülüyor.'
        : '60% of farmers in Europe are adopting sustainable agricultural practices. The goal is to reduce carbon footprint.',
      url: 'https://beyond2c.org',
      image: null,
      publishDate: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
      source: 'European Environment Agency',
      category: language === 'tr' ? 'Sürdürülebilirlik' : 'Sustainability',
      language: language
    },
    {
      id: 'climate-news-10',
      title: language === 'tr' ? 'İklim Teknolojilerinde Yeni Buluş' : 'New Discovery in Climate Technologies',
      summary: language === 'tr' 
        ? 'MIT araştırmacıları atmosferden karbon emebilen yeni bir malzeme geliştirdi. Bu teknoloji iklim değişikliğine karşı güçlü bir araç olabilir.'
        : 'MIT researchers developed a new material that can absorb carbon from the atmosphere. This technology could be a powerful tool against climate change.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-11',
      title: language === 'tr' ? 'Şehirler Net Sıfır Hedefini Benimsiyor' : 'Cities Adopt Net Zero Targets',
      summary: language === 'tr' 
        ? '1000\'den fazla şehir 2050\'ye kadar net sıfır emisyon hedefini açıkladı. Yerel yönetimler iklim liderliğini üstleniyor.'
        : 'More than 1000 cities announced net zero emission targets by 2050. Local governments are taking climate leadership.',
      url: 'https://beyond2c.org',
      image: null,
    ...
    {
      id: 'climate-news-12',
      title: language === 'tr' ? 'Gençler İklim Adalet Taleplerini Artırıyor' : 'Youth Intensify Climate Justice Demands',
      summary: language === 'tr' 
        ? 'Dünya çapında gençler iklim adaleti için daha güçlü eylemler yapıyor. Hükümetlerden acil eylem çağrıları artıyor.'
        : 'Youth worldwide are taking stronger actions for climate justice. Calls for urgent action from governments are increasing.',
      url: 'https://beyond2c.org',
      image: null,
      publishDate: new Date(Date.now() - 11 * 24 * 60 * 60 * 1000).toISOString(),
      source: 'Fridays for Future',
      category: language === 'tr' ? 'İklim Aktivizmi' : 'Climate Activism',
      language: language
    }
  ];
};
...
const NewsPage: React.FC = () => {
  ...
  // Fetch news from RSS feeds via API
  const fetchNews = async (page: number = 1) => {
    setIsLoading(true);
    try {
      console.log('🔄 Fetching real RSS news from API...');
      ...
      if (data.success && data.data) {
        ...
        console.log(`✅ Loaded ${data.data.length} real RSS news articles from ${data.pagination.total} total`);
      } else {
      ...
      const mockNewsData = generateMockNewsData(language);
      ...
      setTotalPages(Math.ceil(mockNewsData.length / newsPerPage));
      setTotalNews(mockNewsData.length);
